    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item waves-effect"
                    ...
                    @switch(Session::get('lang'))
                        ...
                        @break
                        @default
                            <img src="{{ URL::asset('/assets/images/flags/korea.jpg')}}" alt="Header Korea" height="16"> <span class="align-middle">한국인</span>
                    @endswitch
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    
                    <!-- item-->
                    <a href="{{ route('admin.change-language', 'ko') }}" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('assets/images/flags/korea.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">한국인</span>
                    </a>
                    
                    <!-- item-->
                    <a href="{{ route('admin.change-language', 'en') }}" class="dropdown-item notify-item">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ Auth::check() ? route('admin.admins.edit', Auth::id()) : ''}}"><i class="uil uil-user-circle font-size-18 align-middle text-muted me-1"></i> <span class="align-middle">@lang('translation.View_Profile')</span></a>
